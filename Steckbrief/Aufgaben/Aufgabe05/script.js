...
(function (Aufgabe05) {
    ...
    //Produktarrays
    let festkochend = [linda, annabel, marabel, laratta, glorietta, allians,];
    let mehligkochend = [augusta, adretta, mehlig, ackersegen];
    let exoten = [roteemmalie, violetta, blauerschwede, heiderot, laura, tannenzapfen];
    //For-schleife für Sektion: Festkochend
    let node = document.getElementById("festkochend");
    let childNodeHTML;
    for (let i = 0; i < festkochend.length; i++) {
    ...
    */
    ...
    let node2 = document.getElementById("mehligkochend");
    let childNodeHTML2;
    for (let i = 0; i < mehligkochend.length; i++) {
    ...
    let node3 = document.getElementById("exoten");
    let childNodeHTML3;
    for (let i = 0; i < festkochend.length; i++) {

...
(function (Aufgabe05) {
    ...
    for (let i = 0; i < Aufgabe05.imVerkauf.length; i++) {
        ...
        document.getElementById(Aufgabe05.imVerkauf[i].Name + "select")?.appendChild(newOp1);
        document.getElementById(Aufgabe05.imVerkauf[i].Name + "select")?.appendChild(newOp2);
        //Name hinzugefügt 
